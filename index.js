...
brazilianInfos.statesAndCities = [
   ...
   },
   {
      ...
      cities: [
        { cod: "aguas-claras", label: "Águas Claras"},
		{ cod: "brasilia", label: "Brasília"},
		{ cod: "brazlandia", label: "Brazlândia"},
		{ cod: "candangolandia", label: "Candangolândia"},
		{ cod: "ceilandia", label: "Ceilândia"},
		{ cod: "cruzeiro", label: "Cruzeiro"},
		{ cod: "fercal", label: "Fercal"},
		{ cod: "gama", label: "Gama"},
		{ cod: "guara", label: "Guará"},
		{ cod: "itapoa", label: "Itapoã"},
		{ cod: "jardim-botanico", label: "Jardim Botânico"},
		{ cod: "lago-sul", label: "Lago Sul"},
		{ cod: "lago-norte", label: "Lago Norte"},
		{ cod: "nucleo-bandeirante", label: "Núcleo Bandeirante"},
		{ cod: "park-way", label: "Park Way"},
		{ cod: "paranoa", label: "Paranoá"},
		{ cod: "planaltina", label: "Planaltina"},
		{ cod: "recanto-das-emas", label: "Recanto das Emas"},
		{ cod: "riacho-fundo", label: "Riacho Fundo"},
		{ cod: "riacho-fundo-ii", label: "Riacho Fundo II"},
		{ cod: "samambaia", label: "Samambaia"},
		{ cod: "santa-maria", label: "Santa Maria"},
		{ cod: "sao-sebastiao", label: "São Sebastião"},
		{ cod: "scia", label: "SCIA"},
		{ cod: "sia", label: "SIA"},
		{ cod: "sobradinho-i", label: "Sobradinho I"},
		{ cod: "sobradinho-ii", label: "Sobradinho II"},
		{ cod: "sudoeste-octogonal", label: "Sudoeste/Octogonal"},
		{ cod: "taguatinga", label: "Taguatinga"},
		{ cod: "varjao", label: "Varjão"},
		{ cod: "vicente-pires", label: "Vicente Pires"},
      ]
   },
   {
      cod: "es",
